-- Allow an affected parent to volunteer to cover a declined drive.
-- Creates a new confirmed driver_assignment, moves rider_assignments
-- from the declined assignment to the new one, and marks the old
-- assignment as 'released'.
...
begin
  ...
  -- Verify the caller has an active vehicle in the same group
