-- Allow drivers to change their response (un-decline, un-confirm).
-- Previously, respond_to_driver_assignment rejected any call when the assignment
-- status was not 'tentative', leaving no way to correct a mistaken decline/confirm.
